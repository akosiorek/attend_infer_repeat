...
# print latent_code_prior_loss_per_sample.get_shape()
# print latent_code_prior_loss.get_shape()
# print prior_loss._per_sample.get_shape()
# print prior_loss.value.get_shape()
